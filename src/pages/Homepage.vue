...
export default {
    data() {
        return {
            cards: [
                {link: 'http://localhost:5000/assets/41053be053887e7985d1e70dd93fd21a', title: 'For him', description: 'discover men\'s collection', isShow: false, isChosen: false},
                {link: 'http://localhost:5000/assets/a88ea5944c647f08eaff2b5b08ba3e72', title: 'For her', description: 'discover women\'s collection', isShow: false, isChosen: false},
